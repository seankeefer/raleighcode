 ...
 */
define('SITE_TITLE', 'Raleigh Decoded');

/*
 * What is the name of the place that these laws govern?
 */
define('PLACE_NAME', 'Raleigh');

/*
 * What does this place call its laws?
 */
define('LAWS_NAME', 'Code of Ordinances');
 ...
 */
define('CUSTOM_FUNCTIONS', 'class.Raleigh.inc.php');
 ...
 */
define('API_KEY', 'ihsS5OflVaCrOov0');
